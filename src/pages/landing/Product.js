    ...
    <div key={id} className='sm:w-full'>
      ...
      <div id='info' className='flex flex-col items-center justify-center mt-5'>
        ...
        <button
          ...
          className=' border-[1.5px] border-black rounded-3xl px-1 flex items-center justify-center py-2 sm:pt-0.5 sm:pb-1 m-0 box-border text-xs font-semibold hover:bg-black hover:text-white transition'
        >
