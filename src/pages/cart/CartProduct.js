        ...
        <div id='cart-info-container' className='pl-5 w-1/2 sm:w-1/2 sm:mx-auto flex flex-col items-start sm:justify-center sm:items-center'>
          ...
          >
            <button
              ...
              className='bg-black text-white sm:pb-1 px-2 py-2 mx-auto align-middle leading-none w-6 h-6 rounded-full flex justify-center items-center'
            >
              -
            </button>
            <span
            ...
            <button
              ...
              className='bg-black text-white sm:pb-1 py-2 mx-auto align-middle leading-none w-6 h-6 rounded-full flex justify-center items-center'
            >
              +
            </button>
          </div>
